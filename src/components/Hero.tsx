  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 opacity-30">
        ...
        <svg className="absolute -bottom-24 -right-24 w-96 h-96 text-primary/5" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className="absolute -top-24 -left-24 w-96 h-96 text-primary/5" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          <path fill="currentColor" d="M48.9,-75.9C64.2,-69.1,78.5,-58.7,85.8,-44.5C93.1,-30.2,93.4,-12.1,89.8,4.4C86.2,20.9,78.5,36,68.5,49.3C58.6,62.7,46.3,74.4,31.8,79.9C17.3,85.4,0.5,84.8,-16.6,81.3C-33.7,77.8,-51.1,71.5,-64.8,60.2C-78.5,48.9,-88.5,32.7,-89.8,16C-91.1,-0.7,-83.8,-17.9,-74.7,-32.7C-65.6,-47.4,-54.8,-59.8,-41.8,-67.7C-28.8,-75.7,-14.4,-79.4,0.9,-80.9C16.2,-82.5,33.5,-82.7,48.9,-75.9Z" transform="translate(100 100)" />
        </svg>
      </div>
